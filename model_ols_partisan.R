...
cutoff<-head(sort(republicans$ideology))[4]

##
true_democrats<-filter(subjects_active_anonymized, leftist == 1 & ideology < cutoff)


##republicans first
full_1<-(lm(post_aggtweets_1 ~ pre_aggtweets + f.treatment, data = republicans))

full_7<-(lm(post_aggtweets_7_ex ~ pre_aggtweets + f.treatment, data = republicans))

full_14<-(lm(post_aggtweets_14_ex ~ pre_aggtweets + f.treatment, data = republicans))

full_28<-(lm(post_aggtweets_28_ex ~ pre_aggtweets + f.treatment, data = republicans))
...
p <- ggplot(data = df_full,  
  ...
  ggtitle("Treatment Effects on Republican Subjects") +
...
pdf(file="results/OLS_plot_reps.pdf", height=7, width=12)
print(p)
...
##democrats second
######################################################################
full_1<-(lm(post_aggtweets_1 ~ pre_aggtweets + f.treatment, data = democrats))

full_7<-(lm(post_aggtweets_7_ex ~ pre_aggtweets + f.treatment, data = democrats))

full_14<-(lm(post_aggtweets_14_ex ~ pre_aggtweets + f.treatment, data = democrats))

full_28<-(lm(post_aggtweets_28_ex ~ pre_aggtweets + f.treatment, data = democrats))
...
p <- ggplot(data = df_full,  
  ...
  ggtitle("Treatment Effects on Democrat Subjects") +
  theme(plot.title = element_text(hjust=.5, size = 20), legend.text=element_text(size=20), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
        axis.text.x=element_blank(),
...
pdf(file="results/OLS_plot_dems.pdf", height=7, width=12)
print(p)
...
######################################################################
##true democrats third
######################################################################
full_1<-(lm(post_aggtweets_1 ~ pre_aggtweets + f.treatment, data = true_democrats))

full_7<-(lm(post_aggtweets_7_ex ~ pre_aggtweets + f.treatment, data = true_democrats))

full_14<-(lm(post_aggtweets_14_ex ~ pre_aggtweets + f.treatment, data = true_democrats))

full_28<-(lm(post_aggtweets_28_ex ~ pre_aggtweets + f.treatment, data = true_democrats))
...
p <- ggplot(data = df_full,  
  ...
  ggtitle("Treatment Effects on \"True\" Democrats") +
  theme(plot.title = element_text(hjust=.5, size = 20), legend.text=element_text(size=20), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_blank(),
        axis.text.x=element_blank(),
...
pdf(file="results/OLS_plot_true_dems.pdf", height=7, width=12)
print(p)
